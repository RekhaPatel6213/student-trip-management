    ...
    */
    ...
    function createEventUi(refined, context) {
        ...
        return {
            ...
            width: refined.width || '',
            left: refined.left || '',
            borderRadius: refined.borderRadius || '',
        };
    }
    ...
    */
    ...
    class EventContainer extends BaseComponent {
        ...
        render() {
            ...
            return (h(ContentContainer, Object.assign({}, props /* contains children */, { elRef: this.handleEl, elClasses: [
                    ...
                    ...(props.elClasses || []),
                ], elAttrs: Object.assign({ title: eventRange.def.title}), renderProps: renderProps, generatorName: "eventContent", customGenerator: options.eventContent, defaultGenerator: props.defaultGenerator, classNameGenerator: options.eventClassNames, didMount: options.eventDidMount, willUnmount: options.eventWillUnmount })));
        }
        componentDidUpdate(prevProps) {
    ...
    class BgEvent extends BaseComponent {
        render() {
            let { props } = this;
            let { seg } = props;
            return (h(EventContainer, { elTag: "div", elClasses: ['fc-bg-event'], elStyle: { backgroundColor: seg.eventRange.ui.backgroundColor, width: seg.eventRange.def.ui.width, left: seg.eventRange.def.ui.left, borderRadius: seg.eventRange.def.ui.borderRadius,}, defaultGenerator: renderInnerContent$3, seg: seg, timeText: "", isDragging: false, isResizing: false, isDateSelecting: false, isSelected: false, isPast: props.isPast, isFuture: props.isFuture, isToday: props.isToday, disableDragging: true, disableResizing: true }));
        }
    }
    ...
    class MoreLinkContainer extends BaseComponent {
        ...
        render() {
            let { props, state } = this;
            let typeVar = '';
            if(props.allSegs.length > 0){
                typeVar = props.allSegs[0].eventRange.def.extendedProps.type;
            }
            return (h(ViewContextType.Consumer, null, (context) => {
                ...
                let text = typeof moreLinkText === 'function' // TODO: eventually use formatWithOrdinals
                    ...
                    : typeVar == '' ? `Expand ${moreCnt} ${moreLinkText}` : `${moreCnt} Trip(s)`;
    ...
    */
    ...
    class TableCellMoreLink extends BaseComponent {
        ...
        render() {
            ...
            let backgroundText = '';
            if(allSegs.length > 0){
                if(allSegs[0].eventRange.def.extendedProps.type  == 'day' || allSegs[0].eventRange.def.extendedProps.type  == 'week'){
                    let backgroundTextPer = (100/allSegs.length).toFixed(2);
                    allSegs.map((seg) => {
                        backgroundText += seg.eventRange.ui.backgroundColor +' '+backgroundTextPer+'%, ';
                    });
                    backgroundText = 'linear-gradient(to left, '+backgroundText.substring(0,backgroundText.length - 2)+')';
                }
            }
            
            return (h(MoreLinkContainer, { elClasses: ['fc-daygrid-more-link'], elStyle: { background: backgroundText, }, dateProfile: props.dateProfile, todayRange: props.todayRange, allDayDate: props.allDayDate, moreCnt: props.moreCnt, allSegs: allSegs, hiddenSegs: invisibleSegs, alignmentElRef: props.alignmentElRef, alignGridTop: props.alignGridTop, extraDateSpan: props.extraDateSpan, popoverContent: () => {
    ...
    function compileSegs(singlePlacements) {
        ...
        for (let placement of singlePlacements) {
            ...
            if (!placement.isVisible) {
                ...
                if(placement.seg.eventRange.def.extendedProps.type == 'day' ){
                    invisibleSegs.push(placement.seg);
                }
            }
        }
        ...
        render() {
            ...
            return (h(DayCellContainer, { elTag: "td", elRef: this.handleRootEl, elClasses: [
                ...
                !renderProps.isDisabled &&
                    (props.showDayNumber || hasCustomDayCellContent(options) || props.forceDayTop) ? (h("div", { className: "fc-daygrid-day-top", style: { background: '' } },
                    h(InnerContent, { elTag: "a", elClasses: [
